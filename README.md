...
Note: Press 'q' to stop the camera feed.
📁 Project Structure
...
model_utils.py: Face embedding and representation utilities using DeepFace.
mongo_utils.py: Database operations for MongoDB.
